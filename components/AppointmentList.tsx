            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  {/* Visual Fix: Hide service name if the client didn't show up */}
                  {apt.status !== AppointmentStatus.NO_SHOW && (
                    <p className="text-xs font-bold text-brand-gold uppercase tracking-wider mt-1">{apt.serviceName}</p>
                  )}
                </div>
                ...
                <div className="mt-5 flex justify-between items-center pt-4 border-t border-dashed border-white/5">
                  ...
                  <button 
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-sm text-xs font-bold uppercase tracking-wider transition-all border ${
                      apt.isPaid 
